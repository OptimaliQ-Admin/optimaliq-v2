  ...
  return (
    <>
      ...
      >
        ...
        {teamMembers.length > 0 && (!hasTaken || needsRetake) && (
        ...
        {/* Assessment Rules Message */}
        {hasTaken && !needsRetake && teamMembers.length > 0 && (
          <div className="border-t border-gray-100 p-6 bg-gray-50/50">
            <div className="text-center">
              <FaUsers className="text-gray-400 text-xl mx-auto mb-2" />
              <p className="text-sm text-gray-600 mb-2">Team invitations temporarily disabled</p>
              <p className="text-xs text-gray-500">
                This assessment was completed recently. Team invitations will be available again after 30 days when a retake is needed.
              </p>
            </div>
          </div>
        )}
