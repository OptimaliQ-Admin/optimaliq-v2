...
import PlanHealth from "@/components/dashboard/PlanHealth";
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            onClick={async ()=>{ await fetch('/api/growth-plan/replan', { method:'POST' }); toast.success('Re-plan completed'); await load(); }}
          >Auto‑replan</button>
        </div>
        <PlanHealth planId={plan.id} onFilterBlocked={async ()=>{/* no-op wire later */}} />
      </CardHeader>
