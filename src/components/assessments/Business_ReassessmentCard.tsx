...
const ReassessmentDescriptions: Record<number, string> = {
  ...
  return (
    <>
      <div className="bg-white rounded-lg shadow-lg p-6 space-y-4 transition hover:shadow-xl">
        <h2 className="text-xl font-semibold text-gray-800">📊 Business Reassessment</h2>
        ...
        {hasTaken && (
          <>
            ...
            <p className="text-gray-600">{ReassessmentDescriptions[roundedScore ?? 1]}</p>
