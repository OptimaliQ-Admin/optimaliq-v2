...
export const blogPosts: Record<string, BlogPost> = {
  ...
  "7": {
    ...
    views: "0",
    tags: ["AI", "Strategic Decision-Making", "Leadership", "Growth", "Case Studies", "Digital Transformation"],
    relatedArticles: [1, 2, 4],
    featured: true,
    image: "/images/Blog/Explore how AI is transforming strategic decision-making.jpeg",
    meta_description: "Explore how AI is transforming strategic decision-making, with actionable insights and case studies for growth-focused business leaders.",
    seo_slug: "ai-strategic-decision-making-guided-growth"
  },
  "8": {
    id: 8,
    ...
    views: "0",
    tags: ["Innovation", "Organizational Structure", "Leadership", "Digital Transformation", "Strategy", "Change Management"],
    relatedArticles: [1, 2, 4],
    featured: true,
    image: "/images/Blog/Technology alone doesn't drive innovation.jpeg",
    meta_description: "Unlocking innovation isn't about more tech—it's about rethinking organizational structure. Discover how leaders can remove structural bottlenecks.",
    seo_slug: "innovation-bottleneck-structure-not-technology"
  },
  "9": {
    id: 9,
    ...
    publishDate: "2025-06-29",
    views: "0",
    tags: ["Digital Transformation", "AI Transformation", "Decision Intelligence", "AI Readiness", "Digital Decision-Making", "Organizational Decision-Making", "Strategy"],
    relatedArticles: [1, 7, 8],
    featured: true,
    image: "/images/Blog/Is your tech stack failing you.jpeg",
    meta_description: "Your tech stack might be solid—but if your decision stack is broken, AI won't help. Discover how to diagnose and fix decision-making bottlenecks that block transformation.",
    seo_slug: "tech-stack-vs-decision-stack-business-ai-diagnosis"
  }
};
