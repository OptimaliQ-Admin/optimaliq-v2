  ...
  return (
    <div className="max-w-4xl mx-auto space-y-10">
      ...
      <EnhancedMultiSelectQuestion
        ...
        description="Select all channels that are actively contributing to your growth. Choose up to 6 that matter most."
        options={[
          ...
          { value: "other", label: "Other (please describe)", description: "Custom acquisition channels" },
        ]}
      ...
      <EnhancedMultipleChoiceQuestion
        ...
        description="How well-integrated and effective is your current tech stack? This helps us understand your operational efficiency."
        options={[
          { 
            value: "integrated", 
      ...
      <EnhancedTextAreaQuestion
        ...
        description="How do you keep customers coming back? What&apos;s your hook or lifecycle play? Be specific about your retention strategies."
