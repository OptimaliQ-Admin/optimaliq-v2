  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      ...
      <MultipleChoiceQuestion
        question="How would you rate your customer experience excellence?"
        options={[
          { value: "basic", label: "Basic experience" },
          { value: "good", label: "Good experience" },
          { value: "excellent", label: "Excellent experience" },
          { value: "exceptional", label: "Exceptional experience" },
        ]}
      ...
      <MultipleChoiceQuestion
        ...
        options={[
          ...
          { value: "transformational", label: "Transformational growth" },
        ]}
