...
export default function Score2_Step03({ answers, onAnswer }: Props) {
  return (
    <div className="p-6 max-w-2xl mx-auto">
      {/* Question 1: Customer Foundation */}
      <MultipleChoiceQuestion
        question="How would you rate your customer foundation?"
        options={[
      ...
      {/* Question 2: Team Foundation */}
      <MultipleChoiceQuestion
        question="How would you rate your team foundation?"
        options={[
      ...
      {/* Question 3: Growth Foundation */}
      <MultipleChoiceQuestion
        question="How would you rate your growth foundation?"
        options={[
