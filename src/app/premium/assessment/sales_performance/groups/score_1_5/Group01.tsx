...
export default function Score1_5_Step01({ answers, onAnswer }: Props) {
  return (
    <div className="p-6 max-w-2xl mx-auto">
      {/* Question 1: Strategy Awareness */}
      <MultipleChoiceQuestion
        question="How would you rate your strategy awareness?"
        options={[
          { value: "basic", label: "Basic awareness" },
          { value: "developing", label: "Developing awareness" },
          { value: "established", label: "Established awareness" },
          { value: "advanced", label: "Advanced awareness" },
        ]}
        value={getStringAnswer(answers["what_89a231"])}
        onChange={(val) => onAnswer("what_89a231", val)}
      />

      {/* Question 2: Innovation Awareness */}
      <MultipleChoiceQuestion
        question="How would you rate your innovation awareness?"
        options={[
      ...
      <MultipleChoiceQuestion
        question="How would you rate your market awareness?"
        options={[
