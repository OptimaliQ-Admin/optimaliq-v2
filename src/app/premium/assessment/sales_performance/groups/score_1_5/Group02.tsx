...
export default function Score1_5_Step02({ answers, onAnswer }: Props) {
  return (
    <div className="p-6 max-w-2xl mx-auto">
      {/* Question 1: Process Awareness */}
      <MultipleChoiceQuestion
        question="How would you rate your process awareness?"
        options={[
      ...
      {/* Question 2: Technology Awareness */}
      <MultipleChoiceQuestion
        question="How would you rate your technology awareness?"
        options={[
      ...
      {/* Question 3: Data Awareness */}
      <MultipleChoiceQuestion
        question="How would you rate your data awareness?"
        options={[
