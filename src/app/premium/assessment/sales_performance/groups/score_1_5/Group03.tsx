...
export default function Score1_5_Step03({ answers, onAnswer }: Props) {
  return (
    <div className="p-6 max-w-2xl mx-auto">
      {/* Question 1: Customer Awareness */}
      <MultipleChoiceQuestion
        question="How would you rate your customer awareness?"
        options={[
      ...
      {/* Question 2: Team Awareness */}
      <MultipleChoiceQuestion
        question="How would you rate your team awareness?"
        options={[
      ...
      {/* Question 3: Growth Awareness */}
      <MultipleChoiceQuestion
        question="How would you rate your growth awareness?"
        options={[
