...
export default function Score2_5_Step03({ answers, onAnswer }: Props) {
  return (
    <div className="p-6 max-w-2xl mx-auto">
      {/* Question 1: Customer Development */}
      <MultipleChoiceQuestion
        question="How would you rate your customer development?"
        options={[
      ...
      {/* Question 2: Team Development */}
      <MultipleChoiceQuestion
        question="How would you rate your team development?"
        options={[
      ...
      <MultipleChoiceQuestion
        question="How would you rate your growth development?"
        options={[
