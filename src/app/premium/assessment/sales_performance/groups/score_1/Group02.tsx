  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      ...
      <MultipleChoiceQuestion
        question="How would you rate your process understanding?"
        options={[
      ...
      <MultipleChoiceQuestion
        question="How would you rate your technology understanding?"
        options={[
      ...
      <MultipleChoiceQuestion
        question="How would you rate your data understanding?"
        options={[
