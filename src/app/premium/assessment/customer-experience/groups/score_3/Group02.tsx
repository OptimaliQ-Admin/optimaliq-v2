  ...
  return (
    <div className="space-y-8">
      ...
      <MultipleChoiceQuestion
        ...
        value={getStringAnswer(answers["cx_owner"])}
      ...
      <MultipleChoiceQuestion
        ...
        value={getStringAnswer(answers["customer_journey_tracking"])}
      ...
      <MultipleChoiceQuestion
        ...
        value={getStringAnswer(answers["cx_metrics_review"])}
      ...
      <MultipleChoiceQuestion
        ...
        value={getStringAnswer(answers["employee_enablement"])}
