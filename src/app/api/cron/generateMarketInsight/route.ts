...
export async function GET() {
  ...
  const prompt = `
Act as a McKinsey-caliber business strategist. Analyze the following U.S. market data and news to create a strategic summary and actionable recommendation for growing companies.
